---
name: flutter-drift
description: Drift for Flutter apps. Local SQLite, drift_flutter setup, path_provider, StreamBuilder, cross-platform (mobile/desktop/web), isolate sharing. Use this instead of dart-drift when working in Flutter.
---
