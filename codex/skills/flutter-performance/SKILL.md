...
**Scanner:** `python3 ~/.codex/skills/flutter-performance/scripts/analyze_complexity.py . --format markdown` — Dart-aware first pass; leads, not proof. Reports nothing → inspect hot paths, `build()`, repo/Drift/HTTP loops by hand.
