---
name: dart-drift
description: Drift for non-Flutter Dart (CLI, server-side, backend). PostgreSQL, connection pools, server deployments. Do NOT use for Flutter apps — use flutter-drift instead.
---
